...
%---input---
start_diag = 1189; %1226; %1035;
end_diag = 1225; %1246;  %1045;
r_start = 0.4;  % cm
r_end = 7.6;  % cm
font_size = 15;
legend_font_size = 13;
...
subplot('Position', [0.0950 0.5700 0.3000 0.3850]);
for iplot = 1: n_diag
...
subplot('Position', [0.4800 0.5700 0.3000, 0.3850]);
for iplot = 1: n_diag
...
subplot('Position', [0.0950 0.1100 0.3000 0.3850]);
for iplot = 1: n_diag
...
subplot('Position', [0.4800 0.1100 0.3000 0.3850]);
for iplot = 1: n_diag
...
subplot('Position', [0.82, 0.1, 0.18, 0.85]);
set(gca, 'Visible', 'off');
